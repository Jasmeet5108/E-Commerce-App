            ...
            <nav className='flex justify-between items-center max-w-screen-2xl px-3 mx-auto h-16'>
                ...
                <div className='flex justify-end w-52'>
                    <div className="relative lg:hidden inline-block text-center">
                        ...
                        {isDropdownOpen && (
                             <div className="origin-top-right flex justify-center items-center absolute right-0 mt-2 h-10 w-52 rounded-md shadow-lg text-white bg-slate-800 ring-1 ring-white ring-opacity-5">
